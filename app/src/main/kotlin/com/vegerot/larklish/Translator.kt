...
/**
 * The Sender in English. A bare Han name romanizes well (陈昱萌 → "Chen Yumeng"), but a bot
 * or a group with Han in its name becomes meaningless pinyin — `国际电商风险运营平台` reads
 * "Guo Ji Dian Shang Feng Xian Yun Ying Ping Tai". Lark's engine translates those properly
 * ("Triton Data Security"), and 10 of 257 Relays carry one (Experiment 05 "Soak").
 */
