...
object LarkHttp {
    fun postJson(
        ...
        request("POST", path, path, bearer, timing) { conn ->
    ...
    fun getJson(path: String, params: Map<String, String>, bearer: String): JSONObject {
        ...
        return request("GET", path, "$path?$query", bearer, null) {}
    }
    ...
    private fun request(
        ...
        try {
            ...
            timing?.add("$method $path", (System.nanoTime() - started) / 1_000_000, failed, status)
        }
    }
}
