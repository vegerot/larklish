 ...
 * pair is persisted in [file] (`filesDir/user-token.json`). A new seed (re-run of the tool
 * after the chain died) replaces the file. Access tokens last 2 h, refresh tokens 7 days
 * sliding (Experiment 06 E4). Blocking: call on `Dispatchers.IO`.
 */
class UserToken(
