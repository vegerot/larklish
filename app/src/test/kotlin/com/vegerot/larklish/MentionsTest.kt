...
class MentionsTest {
    ...
    fun placeholdersBecomeAtNames() {
        assertEquals(
            ...
            resolveMentions("@_user_1 这条消息 @_user_2 谢谢", mapOf("@_user_1" to "Max Coplan", "@_user_2" to "Yinghao Li")),
        )
    }

    @Test
    fun tenthMentionIsNotEatenByTheFirst() {
        assertEquals("@Ten @One", resolveMentions("@_user_10 @_user_1", mapOf("@_user_1" to "One", "@_user_10" to "Ten")))
    }
