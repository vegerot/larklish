...
- ❌ `lark-cli api POST /open-apis/translation/v1/text/translate --as bot` fails with
  `app_scope_not_applied` for `translation:text`. The scope must be added in the developer
  console first.
